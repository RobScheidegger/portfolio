...
const experienceList = [
    {
        ...
        timeframe: "April 2020 - August 2020, May 2021 - June 2021",
        technologies: ["C#", "Asp.Net Core", "Azure", "Azure DevOps", "CI/CD", ""]
    },
    {
        ...
        const experiences = experienceList.map((e) => 
            <div class="card shadow p-3 m-4">
                <div class="d-flex flex-column flex-md-row justify-content-between">
                    ...
                    <div class="flex-shrink-0"><span class="text-primary">{e.timeframe}</span></div>
                </div>
            </div>
        );
